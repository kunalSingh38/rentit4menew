...
class ActivelistingScreen extends StatefulWidget {
  const ActivelistingScreen({Key key}) : super(key: key);

  @override
  State<ActivelistingScreen> createState() => _ActivelistingScreenState();
}

class _ActivelistingScreenState extends State<ActivelistingScreen> {
                        ...
                        onTap: () {
                          if (searchvalue == "Enter Title" &&
                            ...
                            if (searchvalue == "Enter Title" ||
                                ...
                                searchvalue.isEmpty) {
                              _activealllistByDate();
                            } else {
                              _activealllistBySearch();
                            }
                          }
                        },
                        child: Card(
  ...
  Future<void> _activealllist() async {
    ...
    var response = await http.post(Uri.parse(BASE_URL + "listings/active"),
  ...
  Future<void> _activealllistByDate() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      alllist.clear();
      _loading = true;
  ...
  Future<void> _activealllistBySearch() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      alllist.clear();
      _loading = true;
